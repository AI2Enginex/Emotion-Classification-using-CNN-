...
class Detect_emotions(Parameters):
    ...
    def predeict_emotions(self):
        ...
        while True:
            ...
            faces = self.face.detectMultiScale(frame)
...
class Load_Image(Parameters):
    ...
    def predict_emotion(self):
        ...
        faces = self.face.detectMultiScale(self.image)
        for (x, y, w, h) in faces:
        ...
        cv2.imshow('Emotion Detector', cv2.resize(self.image, (700, 700)))

        cv2.moveWindow('Emotion Detector', 400, 80)
